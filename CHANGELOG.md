...
- Group dissolution applies rejoin stale-clock resets before emitting final events, preventing spurious stale episodes and divergent updates across restart (scenario 75).

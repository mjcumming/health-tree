...
> **Status: first engine.** The engine and the attention policy pass every story and scenario fixture. The design of record is [docs/rfp.md](docs/rfp.md) (version 0.4, draft for review), and every ADR from 0001 to 0028 is accepted or superseded. Nothing is published to PyPI yet.
